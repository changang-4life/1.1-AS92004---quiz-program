...
v10 - Finishing touches, end-user improvements
...
ABCD = ['A','B', 'C', 'D']  # Creating a list for possible answers makes programming error-handeling way easier / less tedious
 ...
 # Lists of options created for each question in the quizes so programmers can go back and edit questions as they please easily. Makes the quiz functions more concise.
...
def quizA():
    while True:
        ...
        if score >= 3:
            ...
            print(f"You scored {score} points out of 5 points... better luck next time!")
...
while valid_age == False:  # If their age is anything out of the age range, they get asked to re-enter it.
    print("\nPlease enter an age from 5 - 11 years.")
